        ...
        return `
            <form id="clinicRegistrationForm" class="registration-form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" class="form-input" placeholder="${t('passwordPlaceholder')}" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label" for="confirmPassword">${t('confirmPassword')} <span style="color: var(--error)">*</span></label>
                    <input type="password" id="confirmPassword" class="form-input" placeholder="${t('confirmPasswordPlaceholder')}" required>
                </div>
        ...
        return `
            <form id="loginForm" class="login-form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="loginPassword" class="form-input" placeholder="${t('passwordPlaceholder')}" required>
                </div>
